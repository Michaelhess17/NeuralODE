def main(train_dir="/home/michael/Synology/Python/Gait-Signatures/NeuralODE/DDFA_NODE/models/vdp_lovelace", 
         epochs=500, batch_size=64, latent_dim=16, timesteps_per_sample=500, n_hidden=64, lr=2e-4, 
         dec_hidden=32, rnn_hidden=256, dec_dropout=0.2, weight_decay=1e-5, alpha=5e-6, pause_every=1):
    ...
    #data = ddfa_node.load_data_normalize(6, '/home/michael/Synology/Julia/data/VDP_SDEs.npy')
    data = np.load("/home/michael/Synology/Julia/data/VDP_SDEs.npy")
    # time_delayed_data, k, τ = ddfa_node.embed_data(data, maxlags=500)
    k, τ = 4, 12
    time_delayed_data = ddfa_node.takens_embedding(data[:, :8000, :], tau=τ, k=k)
...
main(epochs=30, timesteps_per_sample=1500)
